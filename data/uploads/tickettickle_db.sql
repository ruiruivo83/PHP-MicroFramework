...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 11 sep. 2023 à 14:00
...
--
-- Base de données : `tickettickle_db`
--
...
(20, 'Rui', 'ruivo.rui83@outlook.com', '$2y$10$WvfojWDfbbBPzuGS5LS1WO3Gh2bHY7Lr6qfjNMu5.gRWBeOHRUWNK', NULL, NULL, NULL, 1);

-- --------------------------------------------------------

--
-- Structure de la table `_database_updates`
--

DROP TABLE IF EXISTS `_database_updates`;
CREATE TABLE IF NOT EXISTS `_database_updates` (
  `id` int NOT NULL AUTO_INCREMENT,
  `last_executed_version` char(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Déchargement des données de la table `_database_updates`
--

INSERT INTO `_database_updates` (`id`, `last_executed_version`) VALUES
(1, '202309091546.sql');
